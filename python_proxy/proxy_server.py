...
import socket, select, threading, ssl
...
SERVER_PORT  = 8088
RECV_BUFFER  = 8000
#TARGET_HTTP_HOST  = 'smj.io'
#TARGET_HTTPS_HOST = 'stat.ime.baidu.jp'
TARGET_HTTP_HOST  = ['simejiglobal.com', 'smj.io']
TARGET_HTTPS_HOST = 'simejiglobal.com'
...
class ProxyGear(object):
    ...
    def connectRemote(self):
        ...
        if host in TARGET_HTTPS_HOST and port == 443:
            #host = 'jp01-build64.jp01.baidu.com'
            host = 'jp01-ime-rd00.jp01.baidu.com'
            #port = 8443
            port = 8995
            print "new host:%s and new port: %d" % (host, port)
        if host in TARGET_HTTP_HOST and port == 80:
            #host = 'jp01-build64.jp01.baidu.com'
            host = 'jp01-ime-rd00.jp01.baidu.com'
            port = 8000
            print "new host:%s and new port: %d" % (host, port)
